...
<div id="comments" class="comments-area">
	...
	<?php comment_form( array(
		...
		'comment_notes_before' => wp_kses( '<p class="comment-notes">Want to join the discussion? Feel free to contribute!</p>', array( 'p' => array( 'class' => 'class' ) ) ), // inside the array 'p' => array( 'class' => '' )
